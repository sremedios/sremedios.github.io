...
export function __wbg_lightbox_free(a: number): void;
export function lightbox_new(a: number, b: number, c: number, d: number): number;
...
export function rev(a: number): void;
